...
from src.httpsig import get_digest_prefix
from src.httpsig import create_signed_header
from src.httpsig import sign_post_headers
from src.httpsig import sign_post_headers_new
from src.httpsig import verify_post_headers
from src.httpsig import message_content_digest
from src.cache import update_recent_posts_cache
...
from src.posts import json_post_allows_comments
from src.posts import convert_post_content_to_html
from src.posts import get_actor_from_in_reply_to
from src.posts import regenerate_index_for_box
from src.posts import remove_post_interactions
from src.posts import get_mentioned_people
from src.posts import delete_all_posts
from src.posts import create_public_post
from src.posts import send_post
from src.posts import no_of_followers_on_domain
from src.posts import group_followers_by_domain
from src.posts import archive_posts_for_person
from src.posts import seconds_between_published
from src.follow import clear_follows
from src.follow import clear_followers
...
from src.flags import is_group_actor
...
from src.utils import valid_content_warning
...
from src.utils import remove_markup_tag
from src.utils import remove_style_within_html
from src.utils import html_tag_has_closing
...
from src.timeFunctions import date_string_to_seconds
from src.timeFunctions import date_seconds_to_string
from src.utils import contains_ipv4_address
from src.utils import remove_eol
from src.utils import text_in_file
from src.utils import convert_to_snake_case
from src.utils import get_sha_256
from src.utils import dangerous_svg
from src.utils import get_actor_languages_list
from src.utils import get_category_types
...
from src.utils import camel_case_split
...
from src.utils import get_followers_of_person
...
from src.pgp import extract_pgp_public_key
...
from src.person import set_bio
# from src.person import generate_rsa_key
from src.skills import set_skill_level
from src.skills import actor_skill_value
from src.skills import set_skills_from_dict
from src.skills import actor_has_skill
from src.roles import actor_roles_from_list
from src.roles import set_role
from src.roles import actor_has_role
from src.auth import constant_time_string_check
...
from src.like import like_post
from src.like import send_like_via_server
from src.reaction import reaction_post
from src.reaction import send_reaction_via_server
from src.reaction import valid_emoji_content
from src.announce import announce_public
from src.announce import send_announce_via_server
from src.city import parse_nogo_string
from src.city import spoof_geolocation
from src.city import point_in_nogo
from src.media import get_image_dimensions
from src.media import get_media_path
from src.media import get_attachment_media_type
from src.delete import send_delete_via_server
from src.inbox import valid_inbox
from src.inbox import valid_inbox_filenames
from src.inbox import split_post_collection
from src.categories import guess_hashtag_category
from src.content import remove_link_trackers_from_content
from src.content import format_mixed_right_to_left
from src.content import replace_remote_hashtags
from src.content import add_name_emojis_to_tags
from src.content import combine_textarea_lines
from src.content import detect_dogwhistles
from src.content import remove_script
from src.content import create_edits_html
from src.content import content_diff
from src.content import bold_reading_string
from src.content import safe_web_text
from src.content import words_similarity
from src.content import get_price_from_string
from src.content import limit_repeated_words
from src.content import switch_words
from src.content import extract_text_fields_in_post
from src.content import html_replace_email_quote
from src.content import html_replace_inline_quotes
from src.content import html_replace_quote_marks
from src.content import dangerous_css
from src.content import add_web_links
from src.content import replace_emoji_from_tags
from src.content import add_html_tags
from src.content import remove_long_words
from src.content import replace_content_duplicates
from src.content import remove_text_formatting
from src.content import remove_html_tag
from src.theme import get_themes_list
from src.theme import update_default_themes_list
from src.theme import set_css_param
from src.theme import scan_themes_for_scripts
from src.linked_data_sig import generate_json_signature
from src.linked_data_sig import verify_json_signature
from src.newsdaemon import hashtag_rule_tree
from src.newsdaemon import hashtag_rule_resolve
from src.newswire import get_link_from_rss_item
from src.newswire import xml_podcast_to_dict
from src.newswire import get_newswire_tags
from src.newswire import parse_feed_date
from src.newswire import limit_word_lengths
from src.mastoapiv1 import get_masto_api_v1id_from_nickname
from src.mastoapiv1 import get_nickname_from_masto_api_v1id
from src.webapp_post import remove_incomplete_code_tags
from src.webapp_post import replace_link_variable
from src.webapp_post import prepare_html_post_nickname
from src.speaker import speaker_replace_links
from src.markdown import markdown_to_html
from src.markdown import blog_to_markdown
from src.markdown import blog_to_micron
...
from src.languages import get_links_from_content
from src.languages import add_links_to_content
from src.languages import libretranslate
from src.languages import libretranslate_languages
...
from src.shares import get_shared_items_catalog_via_server
from src.shares import get_offers_via_server
from src.shares import get_wanted_via_server
from src.cwlists import add_cw_from_lists
...
from src.webapp_theme_designer import color_contrast
from src.maps import get_map_links_from_post_content
from src.maps import geocoords_from_map_link
from src.followerSync import get_followers_sync_hash
from src.reading import get_book_link_from_content
from src.reading import get_book_from_post
from src.reading import get_reading_status
from src.reading import store_book_events
from src.conversation import conversation_tag_to_convthread_id
from src.conversation import convthread_id_to_conversation_tag
from src.webapp_utils import add_emoji_to_display_name
from src.blocking import is_blocked_nickname
from src.blocking import is_blocked_domain
from src.filters import filtered_match
from src.gemini import blog_to_gemini
from src.blog import html_blog_post_gemini_links
    ...
    for mod_name in threads_called_in_modules:
        ...
        for thread_str in thread_sections:
            ...
            if def_str in modules[mod_name]['source']:
                ...
                defininition_module = test_str.split('from src.')[-1]
...
def _test_functions():
    ...
    for subdir, _, files in os.walk('.'):
        for source_file in files:
            ...
            source_str: str = \
                load_string(source_file_full, 'EX: test_functions load ' +
                            source_file_full)
            modules[mod_name]['source'] = source_str
            ...
            for line in lines:
                ...
                print('method_name added: ' + mod_name + ' ' + method_name)
    ...
    if bad_function_names:
        ...
        for name in bad_function_names2:
            ...
            function_names_sh += \
                'sed -i "s|' + name + '|' + snake_case_name + '|g" src/*.py\n'
            ctr += 1
    ...
    no_of_functions = len(function_properties.items())
    print('no_of_functions: ' + str(no_of_functions))
    assert no_of_functions > 10
        ...
        for name, properties in function_properties.items():
            ...
            for line in mod_props['lines']:
                ...
                if line_str.startswith('class '):
                    line_ctr += 1
                    continue
                # detect a call to this function within the module
                if name + '(' in line:
...
def run_all_tests():
    ...
    _test_post_field_names('src/daemon.py', ['fields', 'actor_json'])
    _test_post_field_names('src/theme.py', ['config_json'])
    _test_post_field_names('src/inbox.py',
